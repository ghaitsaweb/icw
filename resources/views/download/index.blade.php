                ...
                <tbody>
                   @foreach ($request as $item)
                    ...
                    <td>
                        @if($item->status == 'save')
                        <div class="btn-group">
                        <a href="{{route('user.edit',$item->id)}}" class="btn btn-success"><i class="fa fa-edit" title="Edit"></i></a>
                        </div>
                        <div class="btn-group">
                        <a href="{{route('user.send',$item->id)}}" class="btn btn-primary"><i class="fas fa-paper-plane" title="Kirim Keatasan"></i></a>
                        </div>
