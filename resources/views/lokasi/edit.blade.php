                ...
                @method('patch')
                    <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="id" id="id" placeholder="Masukan Kode"  value="{{$data->id}}" class="form-control">
                                <input type="text" name="kode" id="kode" placeholder="Masukan Kode"  value="{{$data->name_kode}}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="">Nama Gudang</label>
                                    <input type="text" name="nama" id="nama" placeholder="Masukan Nama"  value="{{$data->name_gudang}}" class="form-control">
                                </div>
                                                          </div>
