    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="m-b-0 text-white">Gudang ({{$data->name_gudang}}-{{$data->name_kode}}) </h4>
            </div>
            <div class="card-body">
            ...
            <form>
                ...
                @method('patch')
                    <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label for="">Nama Sub</label>
                                    <input type="text" name="nama" id="nama" placeholder="Masukan Nama" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Keterangan</label>
                                    <input type="text" name="idgudang" id="idgudang" class="form-control" value="{{$id}}">
                                    <input type="text" name="keterangan" id="keterangan" placeholder="Masukan Keterangan" class="form-control">
                                </div>
                                                          </div>
