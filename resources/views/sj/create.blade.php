        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Nomor Surat Jalan (SJ)</h4>
                </div>
                <div class="card-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <select name="IDstock" class="form-control js-example-basic-single" id="IDstock" data-control="select2" required>
                                    <option value="" disabled selected>--PIlih NO SJ--</option>
