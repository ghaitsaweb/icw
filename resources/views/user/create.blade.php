            ...
            <form action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                            ...
                            <input type="hidden" name="prosesinfra">
                            <input type="hidden" name="prosessupplychain"> 
                            <input type="hidden" name="prosesfinance">
                            <input type="hidden" name="aktorfw">
                            ...
                            <input type="text" name="no_req" value="{{$kode}}" class="form-control" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="penyebab" name="penyebab" class="form-control" required>
                                        ...
                                        @foreach($penyebab as $p)
                                            <option value="{{$p->id}}">{{$p->penyebab}}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="akibat" name="akibat" class="form-control" required>
                                        <option value="" disabled selected>--Pilih Akibat--</option>
                                        @foreach($akibat as $a)
                                            <option value="{{$a->id}}">{{$a->akibat}}</option>
                                        @endforeach
                                        <option value="">DLL</option>
                                    </select>
